<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="XtraReportProgress._Default" %>
        ...
        <PanelCollection>
            <dx:PanelContent runat="server">
                <asp:Panel ID="Panel1" runat="server" Visible="False">
                    ...
                    <dx:ReportViewer ID="ReportViewer1" runat="server" Report="<%# new XtraReportProgress.XtraReport1() %>"
                        ReportName="XtraReportProgress.XtraReport1" >
                    </dx:ReportViewer>
                </asp:Panel>
            </dx:PanelContent>
        </PanelCollection>
